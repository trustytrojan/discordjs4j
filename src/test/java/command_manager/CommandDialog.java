...
final class CommandDialog extends MyDialog {
	...
	private JPanel createMainPanel() {
		...
		panel.addFormRow("Type", typeInput);
		panel.addFormRow("Name", nameInput);
		panel.addFormRow("Description", descInput);

		var c = FormPanel.constraintsInsets5();
		c.gridy = 3;
		c.gridwidth = 2;
		...
		panel.addBottomButtons(createButton, cancelButton);
